...
//------------------------------------------------------------------------------------------------------------------
void mystrlwr(char * STmp, int ilen) // функция переводит слово в нижний регистр
{
...
{
	setlocale(LC_ALL, "");
	char SLine[] = "Let's try to print THIS in lower case";  // объявления и инициализация строки
	...
	{	char STmp[n];
		...
		mystrlwr(STmp,j);                            // функция переводит слово в нижний регистр
		STmp[j] = ' ';
		j++;
